...
cat \
$DATA_MAARCHRM_SQL_PATH/pgsql/auth.sql \
$DATA_MAARCHRM_SQL_PATH/pgsql/batchProcessing.sql \
$DATA_MAARCHRM_SQL_PATH/pgsql/digitalResource.linux.sql \
$DATA_MAARCHRM_SQL_PATH/pgsql/lifeCycle.sql \
$DATA_MAARCHRM_SQL_PATH/pgsql/organization.sql \
$DATA_MAARCHRM_SQL_PATH/pgsql/contact.sql \
