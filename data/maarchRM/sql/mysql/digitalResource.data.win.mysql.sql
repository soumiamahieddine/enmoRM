...
INSERT INTO `digitalResource.repository` (`repositoryId`, `repositoryName`, `repositoryReference`, `repositoryType`, `repositoryUri`, `enabled`) VALUES
    ('logs_1', 'Digital resource repository for logs', 'repository_1', 'fileSystem', 'C:/xampp/htdocs/laabs/data/maarchRM/repository/logs_1', true),
    ('logs_2', 'Digital resource repository for logs 2', 'repository_2', 'fileSystem', 'C:/xampp/htdocs/laabs/data/maarchRM/repository/logs_2', true),
    ('archives_1', 'Digital resource repository for archives', 'fileSystem', 'C:/xampp/htdocs/laabs/data/maarchRM/repository/archives_1', true),
    ('archives_2', 'Digital resource repository for archives', 'fileSystem', 'C:/xampp/htdocs/laabs/data/maarchRM/repository/archives_2', true);
