 ...
 */
interface destructionHistoryInterface
{
    /**
     * Search form
     ...
     * @param date   $toDate
     *
     * @uses medona/archiveDestruction/readHistory
     * @return medona/message/destructionHistory
     */
    public function readDestructionHistory($reference = null, $archiver = null, $originator = null, $depositor = null, $archivalAgreement = null, $fromDate = null, $toDate = null);
}
