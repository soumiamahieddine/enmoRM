...
/**
 * Archive transfer reply interface
 *
 * @package Medona
 * @author  Alexis Ragot <alexis.ragot@maarch.org>
 */
interface ArchiveTransferReplyInterface
{
    /**
     * Send the transfer reply
     * @param mixed  $transferMessage The archive transfer message or it's identifier
