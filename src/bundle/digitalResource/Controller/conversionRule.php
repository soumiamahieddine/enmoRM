...
class conversionRule
{
    ...
    public function edit($conversionRuleId = null)
    {
        ...
        if ($conversionRuleId) {
            if (!$this->sdoFactory->exists("digitalResource/conversionRule", $conversionRuleId)) {
                throw \laabs::newException("digitalResource/conversionRuleException", "Conversion rule %s1 not found.", 404, null, [$conversionRuleId]);
            }
    ...
    public function create($conversionRule)
    {
        ...
        if ($this->sdoFactory->exists("digitalResource/conversionRule", array("puid" => $conversionRule->puid))) {
            throw \laabs::newException("digitalResource/conversionRuleException", "Conversion rule with Puid %s1 already exist.", 404, null, [$conversionRule->puid]);
        }
