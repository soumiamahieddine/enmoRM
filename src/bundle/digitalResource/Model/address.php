...
/**
 * Class model that represents an address for a digital resource in a repository 
 *
 * @package Digitalresource
 * @author  Cyril VAZQUEZ (Maarch) <cyril.vazquez@maarch.org>
 * 
 * @pkey [resId, repositoryId]
...
class address
{
    ...
    /**
     * The timestamp of the last check integrity
     *
     * @var timestamp
     */
    public $lastIntegrityCheck;
